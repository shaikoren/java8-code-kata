...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(customer -> customer.getAge()).sorted((x,y) -> x.compareTo(y));
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (x, y ) -> y.compareTo(x);
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted( (x, y)-> y.getBudget().compareTo(x.getBudget()))
                .limit(3)
